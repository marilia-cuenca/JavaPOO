...
;var vc="undefined"!==typeof Uint8Array,wc={};var xc;function zc(a){if(wc!==wc)throw Error("illegal external caller");this.Ja=a;if(null!=a&&0===a.length)throw Error("ByteString should be constructed with non-empty values");}
...
var Lc,Mc=Object.freeze(Fc([]));function Nc(a){if(G(a.u))throw Error("Cannot mutate an immutable Message");}
...
function I(a,b,c,d,e){d=void 0===d?!1:d;(void 0===e?0:e)||Nc(a);a.o&&(a.o=void 0);if(b>=a.m||d)return bd(a)[b]=c,a;void 0!==a.j&&a.m>=a.u.length?(d=a.u.length-1,e=b+a.l,e>=d?(a.u[d]=void 0,a.u[e]=c,a.u.push(a.j)):a.u[e]=c):a.u[b+a.l]=c;void 0!==a.j&&b in a.j&&delete a.j[b];return a}
...
function ed(a,b,c,d){Nc(a);(c=fd(a,c))&&c!==b&&null!=d&&(a.i&&c in a.i&&(a.i[c]=void 0),I(a,c));return I(a,b,d)}
...
function J(a,b,c,d){Nc(a);a.i||(a.i={});null==d?b=d=void 0:b=Uc(d,b).u;a.i[c]=d;return I(a,c,b)}
function id(a,b,c,d,e){Nc(a);a.i||(a.i={});null!=e?b=Uc(e,b).u:b=e=void 0;a.i[c]=e;ed(a,c,d,b)}
function jd(a,b,c,d){Nc(a);if(null!=d){var e=Fc([]);for(var f=!1,g=0;g<d.length;g++)e[g]=Uc(d[g],b).u,f=f||G(e[g]);a.i||(a.i={});a.i[c]=d;Ic(e,!f)}else a.i&&(a.i[c]=void 0),e=Mc;return I(a,c,e)}
function kd(a,b,c,d){Nc(a);var e=hd(a,c,b,void 0,!1);c=null!=d?Uc(d,c):new c;a=dd(a,b,2);e.push(c);a.push(c.u);G(c.u)&&Ic(a,!1)}
function ld(a,b){return cd(a,b)}
function md(a,b){a=cd(a,b);return null==a?"":a}
;function nd(a,b,c){a||(a=od);od=null;var d=this.constructor.i||0,e=0<d,f=this.constructor.j;a?Dc(a)&16&&Bc(a,32):(a=f?[f]:[],Bc(a,48));e&&0<a.length&&Kc(a[a.length-1])&&"g"in a[a.length-1]&&(d=0);this.l=(f?0:-1)-d;this.i=void 0;this.u=a;a:{f=this.u.length;d=f-1;if(f&&(f=this.u[d],Kc(f))){this.j=f;b=Object.keys(f);0<b.length&&db(b,isNaN)?this.m=Number.MAX_VALUE:this.m=d-this.l;break a}void 0!==b&&-1<b?(this.m=Math.max(b,d+1-this.l),this.j=void 0):this.m=Number.MAX_VALUE}if(!e&&this.j&&"g"in this.j)throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');
...
nd.prototype.toJSON=function(){var a=this.u;return Lc?a:Yc(a,Zc,$c)};
function pd(a){Lc=!0;try{return JSON.stringify(a.toJSON(),qd)}finally{Lc=!1}}
nd.prototype.clone=function(){var a=Yc(this.u,ad,Jc);Gc(a);od=a;a=new this.constructor(a);od=null;rd(a,this);return a};
nd.prototype.isMutable=function(){return!G(this.u)};
nd.prototype.toString=function(){return this.u.toString()};
function qd(a,b){return Wc(b)}
function rd(a,b){b.s&&(a.s=b.s.slice());var c=b.i;if(c){b=b.j;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length){var h=a,k=f;k=void 0===k?!1:k;f=G(h.u);var l=hd(h,e[0].constructor,g,k,f);g=dd(h,g,0,void 0===k?!1:k);if(!(h=f)&&(h=g)){if(!g)throw Error("cannot check mutability state of non-array");h=!(Dc(g)&8)}if(h){for(h=0;h<l.length;h++)(k=l[h])&&G(k.u)&&!f&&(l[h]=l[h].Ia(),g[h]=l[h].u);Ic(g,!0)}f=l;for(l=0;l<Math.min(f.length,e.length);l++)rd(f[l],e[l])}}else(f=
gd(a,e.constructor,g,f))&&rd(f,e)}}}}
var od;function sd(a,b,c,d,e,f){(a=a.i&&a.i[c])?Array.isArray(a)?(e=f.Aa?Fc(a.slice()):a,jd(b,0<e.length?e[0].constructor:void 0,c,e)):J(b,a.constructor,c,a):(vc&&d instanceof Uint8Array?e=d.length?new zc(new Uint8Array(d)):xc||(xc=new zc(null)):(Array.isArray(d)&&(e?Bc(d,2):d&&Dc(d)&1&&f.Aa?(e=Array.prototype.slice.call(d),Ec(e,(Dc(d)|0)&-51),d=e):Hc(d)),e=d),I(b,c,e))}
;function td(){nd.apply(this,arguments)}
u(td,nd);td.prototype.Ia=function(){return this};
if(Rc){var ud={};Object.defineProperties(td,(ud[Symbol.hasInstance]=Sc(function(){throw Error(void 0);}),ud))};function L(){td.apply(this,arguments)}
u(L,td);L.prototype.Ia=function(){if(G(this.u)){var a={Aa:!0};var b=G(this.u);if(b&&!a.Aa)throw Error("copyRepeatedFields must be true for frozen messages");b||Hc(this.u);var c=new this.constructor;this.s&&(c.s=this.s.slice());for(var d=this.u,e=0;e<d.length;e++){var f=d[e];if(e===d.length-1&&Kc(f))for(var g in f){var h=+g;Number.isNaN(h)?bd(c)[g]=f[g]:sd(this,c,h,f[g],b,a)}else sd(this,c,e-this.l,f,b,a)}c.o=this;a=c}else a=this;return a};
if(Rc){var vd={};Object.defineProperties(L,(vd[Symbol.hasInstance]=Sc(Object[Symbol.hasInstance]),vd))};var wd=window;sb("csi.gstatic.com");sb("googleads.g.doubleclick.net");sb("partner.googleadservices.com");sb("pubads.g.doubleclick.net");sb("securepubads.g.doubleclick.net");sb("tpc.googlesyndication.com");function xd(a){var b=C("window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||A.$googDebugFname||b}catch(g){e="Not available",c=!0}b=yd(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
return a}
var Jd={yb:"allow-forms",zb:"allow-modals",Ab:"allow-orientation-lock",Bb:"allow-pointer-lock",Cb:"allow-popups",Db:"allow-popups-to-escape-sandbox",Eb:"allow-presentation",Fb:"allow-same-origin",Gb:"allow-scripts",Hb:"allow-top-navigation",Ib:"allow-top-navigation-by-user-activation"},Ld=ab(function(){return Kd()});
...
;var Vd="client_dev_domain client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" ");ia(Vd);function Yd(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;m=l=0}
...
function ae(a){var b=Yd();b.update(a);return b.hb().toLowerCase()}
;var be={};function ce(a){this.i=a||{cookie:""}}
n=ce.prototype;n.isEnabled=function(){if(!A.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{Ca:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
...
he.prototype.l=!1;he.prototype.dispose=function(){this.l||(this.l=!0,this.ba())};
he.prototype.ba=function(){if(this.s)for(;this.s.length;)this.s.shift()()};function ie(a,b){this.type=a;this.i=this.target=b;this.defaultPrevented=this.l=!1}
...
ke.prototype.preventDefault=function(){ke.P.preventDefault.call(this);var a=this.j;a.preventDefault?a.preventDefault():a.returnValue=!1};var me="closure_listenable_"+(1E6*Math.random()|0);var ne=0;function oe(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.ra=e;this.key=++ne;this.ha=this.na=!1}
function pe(a){a.ha=!0;a.listener=null;a.proxy=null;a.src=null;a.ra=null}
;function qe(a){this.src=a;this.listeners={};this.i=0}
qe.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.i++);var g=re(a,b,d,e);-1<g?(b=a[g],c||(b.na=!1)):(b=new oe(b,this.src,f,!!d,e),b.na=c,a.push(b));return b};
...
function re(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.ha&&f.listener==b&&f.capture==!!c&&f.ra==d)return e}return-1}
;var te="closure_lm_"+(1E6*Math.random()|0),ue={},ve=0;function we(a,b,c,d,e){if(d&&d.once)xe(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)we(a,b[f],c,d,e);else c=ye(c),a&&a[me]?a.X(b,c,Na(d)?!!d.capture:!!d,e):ze(a,b,c,!1,d,e)}
...
function Fe(a){if("number"!==typeof a&&a&&!a.ha){var b=a.src;if(b&&b[me])se(b.i,a);else{var c=a.type,d=a.proxy;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Ce(c),d):b.addListener&&b.removeListener&&b.removeListener(d);ve--;(c=Ae(b))?(se(c,a),0==c.i&&(c.src=null,b[te]=null)):pe(a)}}}
function Ce(a){return a in ue?ue[a]:ue[a]="on"+a}
function De(a,b){if(a.ha)a=!0;else{b=new ke(b,this);var c=a.listener,d=a.ra||a.src;a.na&&Fe(a);a=c.call(d,b)}return a}
...
return a[Ge]}
;function He(){he.call(this);this.i=new qe(this);this.W=this;this.D=null}
...
function Ie(a,b){var c=a.D;if(c){var d=[];for(var e=1;c;c=c.D)d.push(c),++e}a=a.W;c=b.type||b;"string"===typeof b?b=new ie(b,a):b instanceof ie?b.target=b.target||a:(e=b,b=new ie(c,a),pb(b,e));e=!0;if(d)for(var f=d.length-1;!b.l&&0<=f;f--){var g=b.i=d[f];e=Je(g,c,!0,b)&&e}b.l||(g=b.i=a,e=Je(g,c,!0,b)&&e,b.l||(e=Je(g,c,!1,b)&&e));if(d)for(f=0;!b.l&&f<d.length;f++)g=b.i=d[f],e=Je(g,c,!1,b)&&e}
He.prototype.ba=function(){He.P.ba.call(this);if(this.i){var a=this.i,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,pe(d[e]);delete a.listeners[c];a.i--}}this.D=null};
He.prototype.X=function(a,b,c,d){return this.i.add(String(a),b,!1,c,d)};
function Je(a,b,c,d){b=a.i.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.ha&&g.capture==c){var h=g.listener,k=g.ra||g.src;g.na&&se(a.i,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
Ke.prototype.dispose=function(){window.removeEventListener("offline",this.o);window.removeEventListener("online",this.o);this.K.Z(this.I);delete Ke.i};
...
signal:f}),5);case 5:g=!0;case 3:Aa(h);a.A=void 0;a.m&&(a.K.Z(a.m),a.m=0);g!==a.j&&(a.j=g,a.j?Ie(a,"networkstatus-online"):Ie(a,"networkstatus-offline"));c(g);Ba(h);break;case 2:za(h),g=!1,h.v(3)}})})}
...
u(Re,L);function Te(a,b){return I(a,2,b)}
...
u(Ze,L);var Se=[10,6];var cf="platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");function df(a){var b;return null!=(b=a.google_tag_data)?b:a.google_tag_data={}}
...
u(Gf,Bf);Gf.prototype.next=function(){return this.j.next()};
...
function pg(a,b,c){var d=Sf.get();d.j=a;d.onRejected=b;d.context=c;return d}
Pf.prototype.then=function(a,b,c){return qg(this,"function"===typeof a?a:null,"function"===typeof b?b:null,c)};
Pf.prototype.$goog_Thenable=!0;Pf.prototype.cancel=function(a){if(0==this.i){var b=new rg(a);tf(function(){sg(this,b)},this)}};
...
function qg(a,b,c,d){var e=pg(null,null,null);e.i=new Pf(function(f,g){e.j=b?function(h){try{var k=b.call(d,h);f(k)}catch(l){g(l)}}:f;
e.onRejected=c?function(h){try{var k=c.call(d,h);void 0===k&&h instanceof rg?g(h):f(k)}catch(l){g(l)}}:g});
e.i.l=a;vg(a,e);return e.i}
Pf.prototype.I=function(a){this.i=0;Qf(this,2,a)};
Pf.prototype.W=function(a){this.i=0;Qf(this,3,a)};
function Qf(a,b,c){if(0==a.i){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.i=1;a:{var d=c,e=a.I,f=a.W;if(d instanceof Pf){vg(d,pg(e||Za,f||null,a));var g=!0}else{if(d)try{var h=!!d.$goog_Thenable}catch(l){h=!1}else h=!1;if(h)d.then(e,f,a),g=!0;else{if(Na(d))try{var k=d.then;if("function"===typeof k){xg(d,k,e,f,a);g=!0;break a}}catch(l){f.call(a,l);g=!0;break a}g=!1}}}g||(a.A=c,a.i=b,a.l=null,wg(a),3!=b||c instanceof rg||yg(a,c))}}
...
var Ag=mf;function rg(a){Xa.call(this,a)}
D(rg,Xa);rg.prototype.name="cancel";function N(a){he.call(this);this.A=1;this.m=[];this.o=0;this.i=[];this.j={};this.D=!!a}
D(N,he);n=N.prototype;n.subscribe=function(a,b,c){var d=this.j[a];d||(d=this.j[a]=[]);var e=this.A;this.i[e]=a;this.i[e+1]=b;this.i[e+2]=c;this.A=e+3;d.push(e);return e};
function Bg(a,b,c){var d=Cg;if(a=d.j[a]){var e=d.i;(a=a.find(function(f){return e[f+1]==b&&e[f+2]==c}))&&d.la(a)}}
...
n.ba=function(){N.P.ba.call(this);this.clear();this.m.length=0};function Eg(a){this.i=a}
...
Kg.prototype.clear=function(){var a=Array.from(this);a=t(a);for(var b=a.next();!b.done;b=a.next())this.remove(b.value)};function Lg(a){this.i=a}
...
u(Tg,L);Tg.prototype.getKey=function(){return cd(this,1)};
...
u(Vg,L);function Wg(a){L.call(this,a)}
u(Wg,L);function Xg(a){L.call(this,a,-1,Yg)}
u(Xg,L);var Yg=[2];function Zg(a){L.call(this,a,-1,$g)}
u(Zg,L);Zg.prototype.getPlayerType=function(){return cd(this,36)};
...
u(ah,L);var bh=[15,26,28];function ch(a){L.call(this,a)}
u(ch,L);ch.prototype.setToken=function(a){return I(this,2,a)};function dh(a){L.call(this,a,-1,eh)}
u(dh,L);dh.prototype.setSafetyMode=function(a){return I(this,5,a)};
var eh=[12];function fh(a){L.call(this,a,-1,gh)}
u(fh,L);var gh=[12];function hh(a){L.call(this,a,-1,ih)}
u(hh,L);function jh(a){L.call(this,a)}
u(jh,L);jh.prototype.getKey=function(){return md(this,1)};
...
u(kh,L);function lh(a){L.call(this,a)}
u(lh,L);var mh=[2,3,4];function nh(a){L.call(this,a)}
u(nh,L);function oh(a){L.call(this,a)}
u(oh,L);function ph(a){L.call(this,a)}
u(ph,L);function qh(a){L.call(this,a,-1,rh)}
u(qh,L);var rh=[10,17];function sh(a){L.call(this,a)}
u(sh,L);function th(a){L.call(this,a)}
u(th,L);function uh(a){L.call(this,a)}
u(uh,L);function vh(a){L.call(this,a,442)}
u(vh,L);
...
u(xh,L);function yh(a){L.call(this,a)}
u(yh,L);yh.prototype.setVideoId=function(a){return ed(this,1,zh,a)};
yh.prototype.getPlaylistId=function(){return ld(this,2===fd(this,zh)?2:-1)};
var zh=[1,2];function Ah(a){L.call(this,a,-1,Bh)}
u(Ah,L);var Bh=[3];var Ch=A.window,Dh,Eh,Fh=(null==Ch?void 0:null==(Dh=Ch.yt)?void 0:Dh.config_)||(null==Ch?void 0:null==(Eh=Ch.ytcfg)?void 0:Eh.data_)||{};B("yt.config_",Fh);function Gh(){var a=arguments;1<a.length?Fh[a[0]]=a[1]:1===a.length&&Object.assign(Fh,a[0])}
function P(a,b){return a in Fh?Fh[a]:b}
function Hh(){return P("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS")}
...
function Mh(a,b,c,d){var e=C("yt.logging.errors.log");e?e(a,"ERROR",b,c,d):(e=P("ERRORS",[]),e.push([a,"ERROR",b,c,d]),Gh("ERRORS",e));Kh(a)}
function Nh(a,b,c,d){var e=C("yt.logging.errors.log");e?e(a,"WARNING",b,c,d):(e=P("ERRORS",[]),e.push([a,"WARNING",b,c,d]),Gh("ERRORS",e))}
...
;var Zh=/^[\w.]*$/,$h={q:!0,search_query:!0};function ai(a,b){b=a.split(b);for(var c={},d=0,e=b.length;d<e;d++){var f=b[d].split("=");if(1==f.length&&f[0]||2==f.length)try{var g=bi(f[0]||""),h=bi(f[1]||"");g in c?Array.isArray(c[g])?hb(c[g],h):c[g]=[c[g],h]:c[g]=h}catch(q){var k=q,l=f[0],m=String(ai);k.args=[{key:l,value:f[1],query:a,method:ci==m?"unchanged":m}];$h.hasOwnProperty(l)||Nh(k)}}return c}
...
function hi(a){var b=P("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:P("EXPERIMENT_FLAGS",{})[a]}
function ji(){var a=[],b=P("EXPERIMENTS_FORCED_FLAGS",{});for(c in b)a.push({key:c,value:String(b[c])});var c=P("EXPERIMENT_FLAGS",{});for(var d in c)d.startsWith("force_")&&void 0===b[d]&&a.push({key:d,value:String(c[d])});return a}
...
function ui(a,b){b.includeDomain&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=P("XSRF_FIELD_NAME");if(b=b.urlParams)b[c]&&delete b[c],a=fi(a,b||{},!0);return a}
function vi(a,b){var c=P("XSRF_FIELD_NAME"),d=P("XSRF_TOKEN"),e=b.postBody||"",f=b.postParams,g=P("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.excludeXsrf||Qb(a)&&!b.withCredentials&&Qb(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.postParams&&b.postParams[g]||(f||(f={}),f[c]=d);(R("ajax_parse_query_data_only_when_filled")&&f&&0<Object.keys(f).length||f)&&"string"===typeof e&&(e=ei(e),pb(e,f),e=b.postBodyFormat&&"JSON"==b.postBodyFormat?
...
function Ji(){return{innertubeApiKey:P("INNERTUBE_API_KEY"),innertubeApiVersion:P("INNERTUBE_API_VERSION"),Ba:P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Qa:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),nb:P("INNERTUBE_CONTEXT_CLIENT_NAME",1),innertubeContextClientVersion:P("INNERTUBE_CONTEXT_CLIENT_VERSION"),Sa:P("INNERTUBE_CONTEXT_HL"),Ra:P("INNERTUBE_CONTEXT_GL"),ob:P("INNERTUBE_HOST_OVERRIDE")||"",qb:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),pb:!!P("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:P("SERIALIZED_CLIENT_CONFIG_DATA")}}
function Ki(a){var b={client:{hl:a.Sa,gl:a.Ra,clientName:a.Qa,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ba}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=A.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=P("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=ji();0<c.length&&(b.request={internalExperimentFlags:c});Li(a,void 0,b);Mi(void 0,b);Ni(a,void 0,b);Oi(void 0,b);P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&
(b.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});a=Object;c=a.assign;for(var d=b.client,e={},f=t(Object.entries(ei(P("DEVICE","")))),g=f.next();!g.done;g=f.next()){var h=t(g.value);g=h.next().value;h=h.next().value;"cbrand"===g?e.deviceMake=h:"cmodel"===g?e.deviceModel=h:"cbr"===g?e.browserName=h:"cbrver"===g?e.browserVersion=h:"cos"===g?e.osName=h:"cosver"===g?e.osVersion=h:"cplatform"===g&&(e.platform=h)}b.client=c.call(a,d,e);return b}
function Pi(a){var b=new fh,c=new Zg;I(c,1,a.Sa);I(c,2,a.Ra);I(c,16,a.nb);I(c,17,a.innertubeContextClientVersion);if(a.Ba){var d=a.Ba,e=new Vg;d.coldConfigData&&I(e,1,d.coldConfigData);d.appInstallData&&I(e,6,d.appInstallData);d.coldHashData&&I(e,3,d.coldHashData);d.hotHashData&&I(e,5,d.hotHashData);J(c,Vg,62,e)}(d=A.devicePixelRatio)&&1!=d&&I(c,65,d);d=P("EXPERIMENTS_TOKEN","");""!==d&&I(c,54,d);d=ji();if(0<d.length){e=new ah;for(var f=0;f<d.length;f++){var g=new Tg;I(g,1,d[f].key);g.setValue(d[f].value);
kd(e,15,Tg,g)}J(b,ah,5,e)}Li(a,c);Mi(c);Ni(a,c);Oi(c);P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(a=new dh,I(a,3,P("DELEGATED_SESSION_ID")));a=t(Object.entries(ei(P("DEVICE",""))));for(d=a.next();!d.done;d=a.next())e=t(d.value),d=e.next().value,e=e.next().value,"cbrand"===d?I(c,12,e):"cmodel"===d?I(c,13,e):"cbr"===d?I(c,87,e):"cbrver"===d?I(c,88,e):"cos"===d?I(c,18,e):"cosver"===d?I(c,19,e):"cplatform"===d&&I(c,42,e);J(b,Zg,1,c);return b}
function Li(a,b,c){a=a.Qa;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=gd(b,Wg,96)||new Wg;var d=Ci();d=Object.keys(Bi).indexOf(d);d=-1===d?null:d;null!==d&&I(c,3,d);J(b,Wg,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Ci())}
...
function Qi(a,b,c){c=void 0===c?{}:c;var d={};P("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":P("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Pb||P("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Ob:b=ge([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
;function Ri(a){a=Object.assign({},a);delete a.Authorization;var b=ge();if(b){var c=new zf;c.update(P("INNERTUBE_API_KEY"));c.update(b);a.hash=uc(c.digest(),3)}return a}
...
Si.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.i)try{this.i.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Nf(b))}catch(f){return}else e=escape(b);b=this.j;de.set(""+a,e,{Ca:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
cj.prototype.Z=function(a){if(void 0===a||!Number.isNaN(Number(a))){var b=C("yt.scheduler.instance.cancelJob");b?b(a):window.clearTimeout(a)}};
...
V.all=function(a){return new V(new Dj(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={Y:0};f.Y<a.length;f={Y:f.Y},++f.Y)Ej(V.resolve(a[f.Y]).then(function(g){return function(h){d[g.Y]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})}))};
...
function Mj(a,b,c,d){var e,f,g,h,k,l,m,q,v,p,y,z;return x(function(H){switch(H.i){case 1:var K={mode:"readonly",J:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?K.mode=c:Object.assign(K,c);e=K;a.transactionCount++;f=e.J?3:1;g=0;case 2:if(h){H.v(3);break}g++;k=Math.round(T());wa(H,4);l=a.i.transaction(b,e.mode);K=new Qj(l);K=Rj(K,d);return w(H,K,6);case 6:return m=H.j,q=Math.round(T()),Sj(a,k,q,g,void 0,b.join(),e),H.return(m);case 4:v=za(H);p=Math.round(T());y=zj(v,a.i.name,b.join(),a.i.version);
if((z=y instanceof U&&!y.i)||g>=f)Sj(a,k,p,g,y,b.join(),e),h=y;H.v(2);break;case 3:return H.return(Promise.reject(h))}})}
...
n.delete=function(a){return a instanceof IDBKeyRange?Ik(this,a):W(this.i.delete(a))};
...
n.update=function(a){return W(this.cursor.update(a))};function Ok(a,b,c){return new Promise(function(d,e){function f(){v||(v=new Lj(g.result,{closed:q}));return v}
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,l=c.wb,m=c.upgrade,q=c.closed,v;g.addEventListener("upgradeneeded",function(p){try{if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");p.dataLoss&&"none"!==p.dataLoss&&kj("IDB_DATA_CORRUPTED",{reason:p.dataLossMessage||"unknown reason",dbName:pj(a)});var y=f(),z=new Qj(g.transaction);
...
if(2!=g.i)return xa(g,0);f=za(g);throw zj(f,a,"",-1);})}
...
function Vk(a){function b(){var f,g,h,k,l,m,q,v,p,y;return x(function(z){switch(z.i){case 1:return g=null!=(f=Error().stack)?f:"",wa(z,2),w(z,a.l(a.name,a.options.version,d),4);case 4:h=z.j;for(var H=a.options,K=[],M=t(Object.keys(H.ga)),O=M.next();!O.done;O=M.next()){O=O.value;var ob=H.ga[O],yc=void 0===ob.ub?Number.MAX_VALUE:ob.ub;!(h.i.version>=ob.za)||h.i.version>=yc||h.i.objectStoreNames.contains(O)||K.push(O)}k=K;if(0===k.length){z.v(5);break}l=Object.keys(a.options.ga);m=h.objectStoreNames();
...
a.m=!1,Tk(a,p);return z.return(v);case 10:throw c(),q instanceof Error&&!R("ytidb_async_stack_killswitch")&&(q.stack=q.stack+"\n"+g.substring(g.indexOf("\n")+1)),zj(q,a.name,"",null!=(y=a.options.version)?y:-1);}})}
...
;var Wk=new Sk("YtIdbMeta",{ga:{databases:{za:1}},upgrade:function(a,b){b(1)&&Nj(a,"databases",{keyPath:"actualName"})}});
...
function Zk(a,b){var c,d;return x(function(e){return 1==e.i?(c=[],w(e,Uk(Wk,b),2)):3!=e.i?(d=e.j,w(e,Mj(d,["databases"],{J:!0,mode:"readonly"},function(f){c.length=0;return Jk(f.objectStore("databases"),{},function(g){a(g.U())&&c.push(g.U());return g.continue()})}),3)):e.return(c)})}
...
wa(e,2);d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return w(e,Xk(d,bl),4);case 4:return w(e,Yk("yt-idb-test-do-not-use",bl),5);case 5:return e.return(!0);case 2:return za(e),e.return(!1)}})}
...
function hl(a,b,c,d){var e,f,g,h,k,l;return x(function(m){switch(m.i){case 1:return f=null!=(e=Error().stack)?e:"",w(m,fl(),2);case 2:g=m.j;if(!g)throw h=Aj("openDbImpl",a,b),R("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),jj(h),h;oj(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:gl(a);wa(m,3);return w(m,Xk(k,g),5);case 5:return w(m,Pk(k.actualName,b,d),6);case 6:return m.return(m.j);case 3:return l=za(m),wa(m,7),w(m,Yk(k.actualName,g),9);case 9:xa(m,
...
;function ol(a){this.ma=this.i=!1;this.potentialEsfErrorCounter=this.j=0;this.handleError=function(){};
this.ca=function(){};
...
this.Ea=a.Ea;pl(this)&&(!this.C||this.C("networkless_logging"))&&ql(this)}
function ql(a){pl(a)&&!a.fa&&(a.i=!0,a.qa&&Math.random()<=a.pa&&a.F.gb(a.B),rl(a),a.H.G()&&a.ka(),a.H.X(a.Fa,a.ka.bind(a)),a.H.X(a.Ea,a.La.bind(a)))}
...
this.S(d.url,d.options);this.F.set(d,this.B).then(function(g){d.id=g;e&&c.F.aa(d.id,c.B)}).catch(function(g){tl(c,g)})}else this.S(a,b)};
n.ka=function(){var a=this;if(!pl(this))throw Aj("throttleSend");this.j||(this.j=this.K.M(function(){var b;return x(function(c){if(1==c.i)return w(c,a.F.Pa("NEW",a.B),2);if(3!=c.i)return b=c.j,b?w(c,sl(a,b),3):(a.La(),c.return());a.j&&(a.j=0,a.ka());c.i=0})},this.ab))};
n.La=function(){this.K.Z(this.j);this.j=0};
function sl(a,b){var c,d;return x(function(e){switch(e.i){case 1:if(!pl(a))throw c=Aj("immediateSend"),c;if(void 0===b.id){e.v(2);break}return w(e,a.F.sb(b.id,a.B),3);case 3:(d=e.j)?b=d:a.ca(Error("The request cannot be found in the database."));case 2:if(ul(a,b,a.Xa)){e.v(4);break}a.ca(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.v(5);break}return w(e,a.F.aa(b.id,a.B),5);case 5:return e.return();case 4:b.skipRetry||(b=vl(a,b));if(!b){e.v(0);break}if(!b.skipRetry||
...
b.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.i){case 1:g=wl(f);if(!(a.C&&a.C("nwl_consider_error_code")&&g||a.C&&!a.C("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.ta)){l.v(2);break}if(!a.H.ia){l.v(3);break}return w(l,a.H.ia(),3);case 3:if(a.H.G()){l.v(2);break}c(e,f);if(!a.C||!a.C("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){l.v(6);break}return w(l,a.F.Ga(b.id,a.B,!1),6);case 6:return l.return();case 2:if(a.C&&a.C("nwl_consider_error_code")&&
...
function rl(a){if(!pl(a))throw Aj("retryQueuedRequests");a.F.Pa("QUEUED",a.B).then(function(b){b&&!ul(a,b,a.Wa)?a.K.M(function(){return x(function(c){if(1==c.i)return void 0===b.id?c.v(2):w(c,a.F.Ga(b.id,a.B),2);rl(a);c.i=0})}):a.H.G()&&a.ka()})}
function tl(a,b){a.bb&&!a.H.G()?a.bb(b):a.handleError(b)}
function pl(a){return!!a.B||a.ma}
function wl(a){var b;return(a=null==a?void 0:null==(b=a.error)?void 0:b.code)&&400<=a&&599>=a?!1:!0}
;var xl=C("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.la;N.prototype.publish=N.prototype.da;N.prototype.clear=N.prototype.clear;B("ytPubsub2Pubsub2Instance",xl);B("ytPubsub2Pubsub2SubscribedKeys",C("ytPubsub2Pubsub2SubscribedKeys")||{});B("ytPubsub2Pubsub2TopicToKeys",C("ytPubsub2Pubsub2TopicToKeys")||{});B("ytPubsub2Pubsub2IsAsync",C("ytPubsub2Pubsub2IsAsync")||{});B("ytPubsub2Pubsub2SkipSubKey",null);function yl(a,b){Sk.call(this,a,b);this.options=b;oj(a)}
u(yl,Sk);function zl(a,b){var c;return function(){c||(c=new yl(a,b));return c}}
yl.prototype.l=function(a,b,c){c=void 0===c?{}:c;return(this.options.Ha?jl:il)(a,b,Object.assign({},c))};
yl.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Ha?nl:kl)(this.name,a)};
function Al(a,b){return zl(a,b)}
;var Bl;
function Cl(){if(Bl)return Bl();var a={};Bl=Al("LogsDatabaseV2",{ga:(a.LogsRequestsStore={za:2},a),Ha:!1,upgrade:function(b,c,d){c(2)&&Nj(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0});c(3);c(5)&&(d=d.objectStore("LogsRequestsStore"),d.i.indexNames.contains("newRequest")&&d.i.deleteIndex("newRequest"),d.i.createIndex("newRequestV2",["status","interface","timestamp"],{unique:!1}));c(7)&&b.i.objectStoreNames.contains("sapisid")&&b.i.deleteObjectStore("sapisid");c(9)&&b.i.objectStoreNames.contains("SWHealthLog")&&b.i.deleteObjectStore("SWHealthLog")},
version:9});return Bl()}
;function Dl(a){return Uk(Cl(),a)}
function El(a,b){var c,d,e,f;return x(function(g){if(1==g.i)return c={startTime:T(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},w(g,Dl(b),2);if(3!=g.i)return d=g.j,e=Object.assign({},a,{options:JSON.parse(JSON.stringify(a.options)),interface:P("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),w(g,Pj(d,e),3);f=g.j;c.xb=T();Fl(c);return g.return(f)})}
function Gl(a,b){var c,d,e,f,g,h,k;return x(function(l){if(1==l.i)return c={startTime:T(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(l,Dl(b),2);if(3!=l.i)return d=l.j,e=P("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,T()],h=IDBKeyRange.bound(f,g),k=void 0,w(l,Mj(d,["LogsRequestsStore"],{mode:"readwrite",J:!0},function(m){return Mk(m.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(q){q.U()&&(k=q.U(),"NEW"===a&&(k.status="QUEUED",q.update(k)))})}),
3);
c.xb=T();Fl(c);return l.return(k)})}
...
function Kl(a){var b,c;return x(function(d){if(1==d.i)return w(d,Dl(a),2);b=d.j;c=T()-2592E6;return w(d,Mj(b,["LogsRequestsStore"],{mode:"readwrite",J:!0},function(e){return Jk(e.objectStore("LogsRequestsStore"),{},function(f){if(f.U().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
;var Ml={},Nl=Al("ServiceWorkerLogsDatabase",{ga:(Ml.SWHealthLog={za:1},Ml),Ha:!0,upgrade:function(a,b){b(1)&&Nj(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1});function Ol(a){return Uk(Nl(),a)}
function Pl(a){var b,c;x(function(d){if(1==d.i)return w(d,Ol(a),2);b=d.j;c=T()-2592E6;return w(d,Mj(b,["SWHealthLog"],{mode:"readwrite",J:!0},function(e){return Jk(e.objectStore("SWHealthLog"),{},function(f){if(f.U().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function Ql(a){var b;return x(function(c){if(1==c.i)return w(c,Ol(a),2);b=c.j;return w(c,b.clear("SWHealthLog"),0)})}
;var Rl={},Sl=0;
function Tl(a){var b=void 0===b?"":b;var c=void 0===c?!1:c;if(a)if(b)wi(a,void 0,"POST",b);else if(P("USE_NET_AJAX_FOR_PING_TRANSPORT",!1))wi(a,void 0,"GET","",void 0,void 0,c);else{b:{try{var d=new Ya({url:a});if(d.l&&d.j||d.m){var e=Pb(a.match(Ob)[5]||null);var f=!(!e||!e.endsWith("/aclk")||"1"!==Vb(a,"ri"));break b}}catch(h){}f=!1}if(f){b:{try{if(window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")){var g=!0;break b}}catch(h){}g=!1}b=g?!0:!1}else b=!1;b||Ul(a)}}
...
;function X(){He.call(this);var a=this;this.m=!1;this.j=Ne();this.j.X("networkstatus-online",function(){if(a.m&&R("offline_error_handling")){var b=Yl().get("errors",!0);if(b){for(var c in b)if(b[c]){var d=new lj(c,"sent via offline_errors");d.name=b[c].name;d.stack=b[c].stack;d.level=b[c].level;Mh(d)}Yl().set("errors",{},2592E3,!0)}}})}
u(X,He);function $l(){if(!X.i){var a=C("yt.networkStatusManager.instance")||new X;B("yt.networkStatusManager.instance",a);X.i=a}return X.i}
...
n.ia=function(a){a=Le(this.j,a);a.then(function(b){R("use_cfr_monitor")&&Wl().requestComplete("generate_204",b)});
return a};
X.prototype.sendNetworkCheckRequest=X.prototype.ia;X.prototype.listen=X.prototype.X;X.prototype.enableErrorFlushing=X.prototype.ib;X.prototype.getWindowStatus=X.prototype.mb;X.prototype.networkStatusHint=X.prototype.R;X.prototype.isNetworkAvailable=X.prototype.G;X.getInstance=$l;function am(a){a=void 0===a?{}:a;He.call(this);var b=this;this.j=this.A=0;this.m=$l();var c=C("yt.networkStatusManager.instance.listen").bind(this.m);c&&(a.va?(this.va=a.va,c("networkstatus-online",function(){bm(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){bm(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){Ie(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Ie(b,"publicytnetworkstatus-offline")})))}
u(am,He);am.prototype.G=function(){var a=C("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.m)():!0};
...
function bm(a,b){a.va?a.j?(Oe.Z(a.A),a.A=Oe.M(function(){a.o!==b&&(Ie(a,b),a.o=b,a.j=T())},a.va-(T()-a.j))):(Ie(a,b),a.o=b,a.j=T()):Ie(a,b)}
;var cm;function dm(){ol.call(this,{F:{gb:Kl,aa:Jl,Pa:Gl,sb:Hl,Ga:Il,set:El},H:em(),handleError:Mh,ca:Nh,S:fm,now:T,bb:Zl,K:dj(),Fa:"publicytnetworkstatus-online",Ea:"publicytnetworkstatus-offline",qa:!0,pa:.1,ta:ii("potential_esf_error_limit",10),C:R,fa:!(mj()&&"www.youtube-nocookie.com"!==Qb(document.location.toString()))});this.l=new Of;R("networkless_immediately_drop_all_requests")&&Ll();nl("LogsDatabaseV2")}
u(dm,ol);function gm(){var a=C("yt.networklessRequestController.instance");a||(a=new dm,B("yt.networklessRequestController.instance",a),R("networkless_logging")&&fl().then(function(b){a.B=b;ql(a);a.l.resolve();a.qa&&Math.random()<=a.pa&&a.B&&Pl(a.B);R("networkless_immediately_drop_sw_health_store")&&hm(a)}));
return a}
...
function em(){cm||(cm=new am({rb:!0,jb:!0}));return cm}
...
b=void 0===b?{}:b;R("skip_is_supported_killswitch")?fl().then(function(d){c(d)}):c(el())}
function tm(){var a=el();if(!a)throw Aj("throttleSend");jm||(jm=Oe.M(function(){var b;return x(function(c){if(1==c.i)return w(c,Gl("NEW",a),2);if(3!=c.i)return b=c.j,b?w(c,rm(b),3):(Oe.Z(jm),jm=0,c.return());jm&&(jm=0,tm());c.i=0})},100))}
...
return a}
function om(){if(R("use_new_nwl"))return em();lm||(lm=new am({rb:!0,jb:!0}));return lm}
...
function Zi(a,b,c,d){function e(y){y=void 0===y?!1:y;var z;if(d.retry&&"www.youtube-nocookie.com"!=h&&(y||R("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(z=Wi(b,c,l,k)),z)){var H=g.onSuccess,K=g.onFetchSuccess;g.onSuccess=function(M,O){Xi(z);H(M,O)};
c.onFetchSuccess=function(M,O){Xi(z);K(M,O)}}try{y&&d.retry&&!d.Ua.bypassNetworkless?(g.method="POST",d.Ua.writeThenSend?R("use_new_nwl_wts")?gm().writeThenSend(p,g):nm(p,g):R("use_new_nwl_saw")?gm().sendAndWrite(p,g):sm(p,g)):R("web_all_payloads_via_jspb")?ti(p,g):(g.method="POST",g.postParams||(g.postParams={}),ti(p,g))}catch(M){if("InvalidAccessError"==M.name)z&&(Xi(z),z=0),Nh(Error("An extension is blocking network request."));
...
timeout:d.timeout,withCredentials:!0};g.headers["Content-Type"]||(g.headers["Content-Type"]="application/json");var h="";(f=a.config_.ob)&&(h=f);var k=a.config_.qb||!1,l=Qi(k,h,d);Object.assign(g.headers,l);(f=g.headers.Authorization)&&!h&&(g.headers["x-origin"]=window.location.origin);var m="/youtubei/"+a.config_.innertubeApiVersion+"/"+b,q={alt:"json"},v=a.config_.pb&&f;v=v&&f.startsWith("Bearer");v||(q.key=a.config_.innertubeApiKey);var p=fi(""+h+m,q||{},!0);R("use_new_nwl")&&gm().i||!R("use_new_nwl")&&
pm()?dl().then(function(y){e(y)}):e(!1)}
;var xm=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function ym(a){this.I=a;this.i=null;this.o=0;this.D=null;this.A=0;this.j=[];for(a=0;4>a;a++)this.j.push(0);this.m=0;this.wa=Wh(window,"mousemove",Va(this.xa,this));this.ya=Yh(Va(this.W,this),25)}
D(ym,he);ym.prototype.xa=function(a){void 0===a.i&&Rh(a);var b=a.i;void 0===a.j&&Rh(a);this.i=new Ed(b,a.j)};
ym.prototype.W=function(){if(this.i){var a=xm();if(0!=this.o){var b=this.D,c=this.i,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.o);this.j[this.m]=.5<Math.abs((d-this.A)/this.A)?1:0;for(c=b=0;4>c;c++)b+=this.j[c]||0;3<=b&&this.I();this.A=d}this.o=a;this.D=this.i;this.m=(this.m+1)%4}};
ym.prototype.ba=function(){window.clearInterval(this.ya);Uh(this.wa)};var zm={};
function Am(){var a={},b=void 0===a.tb?!1:a.tb;a=void 0===a.kb?!0:a.kb;if(null==C("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;B("_lact",c,window);B("_fact",c,window);-1==c&&Bm();Wh(document,"keydown",Bm);Wh(document,"keyup",Bm);Wh(document,"mousedown",Bm);Wh(document,"mouseup",Bm);b?Wh(window,"touchmove",function(){Cm("touchmove",200)},{passive:!0}):(Wh(window,"resize",function(){Cm("resize",200)}),a&&Wh(window,"scroll",function(){Cm("scroll",200)}));
...
;var Em=A.ytPubsubPubsubInstance||new N,Fm=A.ytPubsubPubsubSubscribedKeys||{},Gm=A.ytPubsubPubsubTopicToKeys||{},Hm=A.ytPubsubPubsubIsSynchronous||{};N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.la;N.prototype.publish=N.prototype.da;N.prototype.clear=N.prototype.clear;B("ytPubsubPubsubInstance",Em);B("ytPubsubPubsubTopicToKeys",Gm);B("ytPubsubPubsubIsSynchronous",Hm);B("ytPubsubPubsubSubscribedKeys",Fm);function Im(){this.store=[];this.i={}}
Im.prototype.storePayload=function(a,b){this.store.push({payload:b,keys:a});a=Jm(a);this.i[a]?this.i[a]++:this.i[a]=1;return a};
Im.prototype.extractMatchingEntries=function(a){for(var b=[],c=[],d=t(this.store),e=d.next();!e.done;e=d.next()){e=e.value;a:{var f=a;var g=Object.keys(f);g=t(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value,e.keys[h]!==f[h]){f=!1;break a}f=!0}f?(b.push(e.payload),this.i[Jm(e.keys)]--):c.push(e)}this.store=c;a=Km(this,a);a=t(a);for(c=a.next();!c.done;c=a.next())c=c.value,0<this.i[c]&&Nh(new lj("Transport IMS did not fully extract entries for key:",{sequence:c,Vb:b.length,Tb:this.i[c]}));return b};
Im.prototype.getSequenceCount=function(a){var b=Km(this,a);a=0;b=t(b);for(var c=b.next();!c.done;c=b.next())a+=this.i[c.value];return a};
...
var Qm=new Pm,Rm=new Pm,Sm=!0,Tm=A.ytLoggingTransportGELQueue_||new Map;B("ytLoggingTransportGELQueue_",Tm);var Um=A.ytLoggingTransportGELProtoQueue_||new Map;B("ytLoggingTransportGELProtoQueue_",Um);var Vm=A.ytLoggingTransportTokensToCttTargetIds_||{};B("ytLoggingTransportTokensToCttTargetIds_",Vm);var Wm=A.ytLoggingTransportTokensToJspbCttTargetIds_||{};B("ytLoggingTransportTokensToJspbCttTargetIds_",Wm);var Xm={};function Ym(){var a=C("yt.logging.ims");a||(a=new Im,B("yt.logging.ims",a));return a}
function Zm(a,b){R("web_all_payloads_via_jspb")&&Nh(new lj("transport.log called for JSON in JSPB only experiment"));if("log_event"===a.endpoint){$m(a);var c=an(a);if(R("use_new_in_memory_storage")){Xm[c]=!0;var d={cttAuthInfo:c,isJspb:!1};Ym().storePayload(d,a.payload);bn(b,[],c,!1,d)}else d=Tm.get(c)||[],Tm.set(c,d),d.push(a.payload),bn(b,d,c)}}
function cn(a,b){if("log_event"===a.endpoint){$m(void 0,a);var c=an(a,!0);if(R("use_new_in_memory_storage")){Xm[c]=!0;var d={cttAuthInfo:c,isJspb:!0};Ym().storePayload(d,a.payload.toJSON());bn(b,[],c,!0,d)}else d=Um.get(c)||[],Um.set(c,d),a=a.payload.toJSON(),d.push(a),bn(b,d,c,!0)}}
function bn(a,b,c,d,e){d=void 0===d?!1:d;a&&(Om=new a);a=ii("tvhtml5_logging_max_batch")||ii("web_logging_max_batch")||100;var f=T(),g=d?Rm.l:Qm.l;b=b.length;e&&(b=Ym().getSequenceCount(e));b>=a?R("background_thread_flush_logs_due_to_batch_limit")?Xh(function(){dn({writeThenSend:!0},R("flush_only_full_queue")?c:void 0,d)},0):dn({writeThenSend:!0},R("flush_only_full_queue")?c:void 0,d):10<=f-g&&(en(d),d?Rm.l=f:Qm.l=f)}
function fn(a,b){R("web_all_payloads_via_jspb")&&Nh(new lj("transport.logIsolatedGelPayload called in JSPB only experiment"));if("log_event"===a.endpoint){$m(a);var c=an(a),d=new Map;d.set(c,[a.payload]);b&&(Om=new b);return new Pf(function(e,f){Om&&Om.isReady()?gn(d,Om,e,f,{bypassNetworkless:!0},!0):e()})}}
function hn(a,b){if("log_event"===a.endpoint){$m(void 0,a);var c=an(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(Om=new b);return new Pf(function(e){Om&&Om.isReady()?jn(d,Om,e,{bypassNetworkless:!0},!0):e()})}}
function an(a,b){var c="";if(a.ea)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new yh;c.videoId?d.setVideoId(c.videoId):c.playlistId&&ed(d,2,zh,c.playlistId);Wm[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Vm[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function dn(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;!c&&R("web_all_payloads_via_jspb")&&Nh(new lj("transport.flushLogs called for JSON in JSPB only experiment"));new Pf(function(d,e){c?(window.clearTimeout(Rm.j),window.clearTimeout(Rm.i),Rm.i=0):(window.clearTimeout(Qm.j),window.clearTimeout(Qm.i),Qm.i=0);if(Om&&Om.isReady())if(R("use_new_in_memory_storage")){var f=a,g=c,h=Om;f=void 0===f?{}:f;g=void 0===g?!1:g;var k=new Map,l=new Map;if(void 0!==b)g?(e=Ym().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),
k.set(b,e),jn(k,h,d,f)):(k=Ym().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),l.set(b,k),gn(l,h,d,e,f));else if(g){e=t(Object.keys(Xm));for(g=e.next();!g.done;g=e.next())l=g.value,g=Ym().extractMatchingEntries({isJspb:!0,cttAuthInfo:l}),0<g.length&&k.set(l,g),delete Xm[l];jn(k,h,d,f)}else{k=t(Object.keys(Xm));for(g=k.next();!g.done;g=k.next()){g=g.value;var m=Ym().extractMatchingEntries({isJspb:!1,cttAuthInfo:g});0<m.length&&l.set(g,m);delete Xm[g]}gn(l,h,d,e,f)}}else f=a,k=c,h=Om,f=void 0===f?
{}:f,k=void 0===k?!1:k,void 0!==b?k?(e=new Map,k=Um.get(b)||[],e.set(b,k),jn(e,h,d,f),Um.delete(b)):(k=new Map,l=Tm.get(b)||[],k.set(b,l),gn(k,h,d,e,f),Tm.delete(b)):k?(jn(Um,h,d,f),Um.clear()):(gn(Tm,h,d,e,f),Tm.clear());else en(c),d()})}
function en(a){a=void 0===a?!1:a;if(R("web_gel_timeout_cap")&&(!a&&!Qm.i||a&&!Rm.i)){var b=Xh(function(){dn({writeThenSend:!0},void 0,a)},6E4);
a?Rm.i=b:Qm.i=b}window.clearTimeout(a?Rm.j:Qm.j);b=P("LOGGING_BATCH_TIMEOUT",ii("web_gel_debounce_ms",1E4));R("shorten_initial_gel_batch_timeout")&&Sm&&(b=Mm);b=Xh(function(){dn({writeThenSend:!0},void 0,a)},b);
a?Rm.j=b:Qm.j=b}
function gn(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(T()),h=a.size;a=t(a);for(var k=a.next();!k.done;k=a.next()){var l=t(k.value);k=l.next().value;var m=l.next().value;l=k;k=mb({context:Ki(b.config_||Ji())});if(!Ma(m)&&!R("throw_err_when_logevent_malformed_killswitch")){d();break}k.events=m;(m=Vm[l])&&kn(k,l,m);delete Vm[l];l="visitorOnlyApprovedKey"===l;ln(k,g,l);mn(e);m=function(){h--;h||c()};
var q=function(){h--;h||c()};
try{Zi(b,"log_event",k,nn(e,l,m,q,f)),Sm=!1}catch(v){Mh(v),d()}}}
function jn(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(T()),g=a.size,h=new Map([].concat(ia(a)));h=t(h);for(var k=h.next();!k.done;k=h.next()){var l=t(k.value).next().value,m=a.get(l);k=new Ah;var q=Pi(b.config_||Ji());J(k,fh,1,q);m=m?on(m):[];m=t(m);for(q=m.next();!q.done;q=m.next())kd(k,3,vh,q.value);(m=Wm[l])&&pn(k,l,m);delete Wm[l];l="visitorOnlyApprovedKey"===l;qn(k,f,l);mn(d);k=pd(k);l=nn(d,l,function(){g--;g||c()},function(){g--;
g||c()},e);
l.headers["Content-Type"]="application/json+protobuf";l.postBodyFormat="JSPB";l.postBody=k;Zi(b,"log_event","",l);Sm=!1}}
...
function qn(a,b,c){R("use_request_time_ms_header")||I(a,2,b);if(!c&&(b=P("EVENT_ID"))){c=rn();var d=new xh;I(d,1,b);I(d,2,c);J(a,xh,5,d)}}
function rn(){var a=P("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*Nm/2));a++;a>Nm&&(a=1);Gh("BATCH_CLIENT_COUNTER",a);return a}
...
function pn(a,b,c){if(ld(c,1===fd(c,zh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;J(a,yh,4,c);a=gd(a,fh,1)||new fh;c=gd(a,dh,3)||new dh;var e=new ch;e.setToken(b);I(e,1,d);kd(c,12,ch,e);J(a,dh,3,c)}
function on(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new vh(a[c]))}catch(d){Mh(new lj("Transport failed to deserialize "+String(a[c])))}return b}
...
function tn(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||T());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;R("enable_unknown_lact_fix_on_html5")&&Am();a=Dm();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};R("log_sequence_info_on_gel_web")&&d.ja&&(a=e.context,b=d.ja,b={index:un(b),groupKey:b},a.sequence=b,d.lb&&delete sn[d.ja]);(d.vb?fn:Zm)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,ea:d.ea},c)}
function vn(a){dn(void 0,void 0,void 0===a?!1:a)}
function un(a){sn[a]=a in sn?sn[a]+1:0;return sn[a]}
;var wn=A.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",wn);function xn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;P("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:wm;b=void 0===b?{}:b;var d=Math.round(b.timestamp||T());I(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Dm();d=new uh;I(d,1,b.timestamp||!isFinite(e)?-1:e);if(R("log_sequence_info_on_gel_web")&&b.ja){e=b.ja;var f=un(e),g=new th;I(g,2,f);I(g,1,e);J(d,th,3,g);b.lb&&delete wn[b.ja]}J(a,uh,33,d);(b.vb?hn:cn)({endpoint:"log_event",payload:a,cttAuthInfo:b.cttAuthInfo,ea:b.ea},c)}
;function yn(a,b){var c=void 0===c?{}:c;if(R("migrate_events_to_ts")){c=void 0===c?{}:c;var d=wm;P("ytLoggingEventsDefaultDisabled",!1)&&wm===wm&&(d=null);R("web_all_payloads_via_jspb")&&Nh(new lj("Logs should be translated to JSPB but are sent as JSON instead",a));tn(a,b,d,c)}else d=wm,P("ytLoggingEventsDefaultDisabled",!1)&&wm==wm&&(d=null),tn(a,b,d,c)}
...
;function Sn(){var a;return x(function(b){return(a=gf())?b.return(a.then(function(c){c=pd(c);for(var d=[],e=0,f=0;f<c.length;f++){var g=c.charCodeAt(f);255<g&&(d[e++]=g&255,g>>=8);d[e++]=g}return uc(d,3)})):b.return(Promise.resolve(null))})}
;var Tn={};function Un(a){return Tn[a]||(Tn[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Vn={},Wn=[],Cg=new N,Xn={};function Yn(){for(var a=t(Wn),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
function $n(a){Cg.da.apply(Cg,arguments)}
...
function co(a,b,c){eo||(eo={},Wh(window,"message",function(d){a:{if(d.origin===bo(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=eo[e.id])d.A=!0,d.A&&(E(d.o,d.sendMessage,d),d.o.length=0),d.Ka(e)}e=void 0}return e}));
eo[c]=b}
...
n.destroy=function(){this.i&&this.i.id&&(Vn[this.i.id]=null);var a=this.m;a&&"function"==typeof a.dispose&&a.dispose();if(this.s){a=this.i;var b=a.parentNode;b&&b.replaceChild(this.s,a)}else(a=this.i)&&a.parentNode&&a.parentNode.removeChild(a);eo&&(eo[this.id]=null);this.j=null;a=this.i;for(var c in kb)kb[c][0]==a&&Uh(c);this.s=this.i=null};
...
fo.yt_embedsEnableIframeSrcWithIntent?Dd(c,Sd(h)):c.src=h;
return c}
n.Va=function(){this.i&&this.i.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.l)};
function mo(a){co(a.j,a,a.id);a.l=Yh(a.Va.bind(a),250);Wh(a.i,"load",function(){window.clearInterval(a.l);a.l=Yh(a.Va.bind(a),250)})}
...
h;if(f){f.hasOwnProperty("level")&&f.level&&(h=f.level);if(R("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=Mn)){var m=void 0,q=void 0,v=f,p=g,y=xd(v),z=y.message||"Unknown Error",H=y.name||"UnknownError",
K=y.stack||v.j||"Not available";if(K.startsWith(H+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=y.lineNumber||"Not available",ob=y.fileName||"Not available",yc=K,ya=0;if(v.hasOwnProperty("args")&&v.args&&v.args.length)for(var sa=0;sa<v.args.length&&!(ya=In(v.args[sa],"params."+sa,p,ya),500<=ya);sa++);else if(v.hasOwnProperty("params")&&v.params){var Z=v.params;if("object"===typeof v.params)for(q in Z){if(Z[q]){var da="params."+q,ea=Kn(Z[q]);p[da]=ea;ya+=da.length+ea.length;if(500<ya)break}}else p.params=
Kn(Z)}if(Pn.length)for(var Y=0;Y<Pn.length&&!(ya=In(Pn[Y],"params.context."+Y,p,ya),500<=ya);Y++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:H,lineNumber:O,fileName:ob,stack:yc,params:p,sampleWeight:1},Uj=Number(v.columnNumber);isNaN(Uj)||(S.lineNumber=S.lineNumber+":"+Uj);if("IGNORED"===v.level)m=0;else a:{for(var Vj=En(),Wj=t(Vj.V),Tf=Wj.next();!Tf.done;Tf=Wj.next()){var Xj=Tf.value;if(S.message&&S.message.match(Xj.Sb)){m=Xj.weight;
break a}}for(var Yj=t(Vj.T),Uf=Yj.next();!Uf.done;Uf=Yj.next()){var Zj=Uf.value;if(Zj.fb(S)){m=Zj.weight;break a}}m=1}S.sampleWeight=m;for(var ak=t(zn),Vf=ak.next();!Vf.done;Vf=ak.next()){var Wf=Vf.value;if(Wf.sa[S.name])for(var bk=t(Wf.sa[S.name]),Xf=bk.next();!Xf.done;Xf=bk.next()){var ck=Xf.value,Wd=S.message.match(ck.regexp);if(Wd){S.params["params.error.original"]=Wd[0];for(var Yf=ck.groups,dk={},$b=0;$b<Yf.length;$b++)dk[Yf[$b]]=Wd[$b+1],S.params["params.error."+Yf[$b]]=Wd[$b+1];S.message=Wf.Da(dk);
break}}}S.params||(S.params={});var ek=En();S.params["params.errorServiceSignature"]="msg="+ek.V.length+"&cb="+ek.T.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));sb("sample").constructor!==rb&&(S.params["params.fconst"]="true");var ua=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ua);if(0!==ua.sampleWeight&&!Ln.has(ua.message)){if("ERROR"===h){Fn.da("handleError",
ua);if(R("record_app_crashed_web")&&0===On&&1===ua.sampleWeight)if(On++,R("errors_via_jspb")){var Zf=new sh;I(Zf,1,1);if(!R("report_client_error_with_app_crash_ks")){var fk=new nh;I(fk,1,ua.message);var gk=new oh;J(gk,nh,3,fk);var hk=new ph;J(hk,oh,5,gk);var ik=new qh;J(ik,ph,9,hk);J(Zf,qh,4,ik)}var so=Zf,jk=new vh;id(jk,sh,20,wh,so);xn(jk)}else{var kk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(kk.systemHealth={crashData:{clientError:{logMessage:{message:ua.message}}}});
yn("appCrashed",kk)}Nn++}else"WARNING"===h&&Fn.da("handleWarning",ua);if(R("kevlar_gel_error_routing"))a:{var $f=void 0,ag=void 0,Oc=h,Q=ua;if(R("errors_via_jspb")){if(Rn())ag=void 0;else{var ac=new kh;I(ac,1,Q.stack);Q.fileName&&I(ac,4,Q.fileName);var Oa=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Oa.length&&(1!==Oa.length||isNaN(Number(Oa[0]))?2!==Oa.length||isNaN(Number(Oa[0]))||isNaN(Number(Oa[1]))||(I(ac,2,Number(Oa[0])),I(ac,3,Number(Oa[1]))):I(ac,2,Number(Oa[0])));var vb=
new nh;I(vb,1,Q.message);I(vb,3,Q.name);I(vb,6,Q.sampleWeight);"ERROR"===Oc?I(vb,2,2):"WARNING"===Oc?I(vb,2,1):I(vb,2,0);var bg=new lh;I(bg,1,!0);id(bg,kh,3,mh,ac);var wb=new hh;I(wb,3,window.location.href);for(var lk=P("FEXP_EXPERIMENTS",[]),cg=0;cg<lk.length;cg++){var mk=wb,to=lk[cg];Nc(mk);dd(mk,5,2,!1).push(to)}var dg=Hh();if(!Ih()&&dg)for(var nk=t(Object.keys(dg)),xb=nk.next();!xb.done;xb=nk.next()){var ok=xb.value,eg=new jh;I(eg,1,ok);eg.setValue(String(dg[ok]));kd(wb,4,jh,eg)}var fg=Q.params;
if(fg){var pk=t(Object.keys(fg));for(xb=pk.next();!xb.done;xb=pk.next()){var qk=xb.value,gg=new jh;I(gg,1,"client."+qk);gg.setValue(String(fg[qk]));kd(wb,4,jh,gg)}}var rk=P("SERVER_NAME"),sk=P("SERVER_VERSION");if(rk&&sk){var hg=new jh;I(hg,1,"server.name");hg.setValue(rk);kd(wb,4,jh,hg);var ig=new jh;I(ig,1,"server.version");ig.setValue(sk);kd(wb,4,jh,ig)}var Xd=new oh;J(Xd,hh,1,wb);J(Xd,lh,2,bg);J(Xd,nh,3,vb);ag=Xd}var tk=ag;if(!tk)break a;var uk=new vh;id(uk,oh,163,wh,tk);xn(uk)}else{if(Rn())$f=
void 0;else{var Pc={stackTrace:Q.stack};Q.fileName&&(Pc.filename=Q.fileName);var Pa=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Pa.length&&(1!==Pa.length||isNaN(Number(Pa[0]))?2!==Pa.length||isNaN(Number(Pa[0]))||isNaN(Number(Pa[1]))||(Pc.lineNumber=Number(Pa[0]),Pc.columnNumber=Number(Pa[1])):Pc.lineNumber=Number(Pa[0]));var jg={level:"ERROR_LEVEL_UNKNOWN",message:Q.message,errorClassName:Q.name,sampleWeight:Q.sampleWeight};"ERROR"===Oc?jg.level="ERROR_LEVEL_ERROR":"WARNING"===
Oc&&(jg.level="ERROR_LEVEL_WARNNING");var uo={isObfuscated:!0,browserStackInfo:Pc},bc={pageUrl:window.location.href,kvPairs:[]};P("FEXP_EXPERIMENTS")&&(bc.experimentIds=P("FEXP_EXPERIMENTS"));var kg=Hh();if(!Ih()&&kg)for(var vk=t(Object.keys(kg)),yb=vk.next();!yb.done;yb=vk.next()){var wk=yb.value;bc.kvPairs.push({key:wk,value:String(kg[wk])})}var lg=Q.params;if(lg){var xk=t(Object.keys(lg));for(yb=xk.next();!yb.done;yb=xk.next()){var yk=yb.value;bc.kvPairs.push({key:"client."+yk,value:String(lg[yk])})}}var zk=
P("SERVER_NAME"),Ak=P("SERVER_VERSION");zk&&Ak&&(bc.kvPairs.push({key:"server.name",value:zk}),bc.kvPairs.push({key:"server.version",value:Ak}));$f={errorMetadata:bc,stackTrace:uo,logMessage:jg}}var Bk=$f;if(!Bk)break a;yn("clientError",Bk)}if("ERROR"===Oc||R("errors_flush_gel_always_killswitch"))b:if(R("migrate_events_to_ts"))c:{if(R("web_fp_via_jspb")&&(vn(!0),!R("web_fp_via_jspb_and_json")))break c;vn()}else{if(R("web_fp_via_jspb")&&(vn(!0),!R("web_fp_via_jspb_and_json")))break b;vn()}}if(!R("suppress_error_204_logging")){var zb=
ua,Qc=zb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:zb.name,msg:zb.message.substr(0,250),line:zb.lineNumber,level:h,"client.name":Qc.name},postParams:{url:P("PAGE_NAME",window.location.href),file:zb.fileName},method:"POST"};Qc.version&&($a["client.version"]=Qc.version);if($a.postParams){zb.stack&&($a.postParams.stack=zb.stack);for(var Ck=t(Object.keys(Qc)),mg=Ck.next();!mg.done;mg=Ck.next()){var Dk=mg.value;$a.postParams["client."+Dk]=Qc[Dk]}var ng=Hh();if(ng)for(var Ek=t(Object.keys(ng)),
og=Ek.next();!og.done;og=Ek.next()){var Fk=og.value;$a.postParams[Fk]=ng[Fk]}var Gk=P("SERVER_NAME"),Hk=P("SERVER_VERSION");Gk&&Hk&&($a.postParams["server.name"]=Gk,$a.postParams["server.version"]=Hk)}ti(P("ECATCHER_REPORT_HOST","")+"/error_204",$a)}try{Ln.add(ua.message)}catch(zo){}Mn++}}}}}else throw Zb;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function no(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
B("YT.scan",Yn);B("YT.subscribe",function(a,b,c){Cg.subscribe(a,b,c);Xn[a]=!0;for(var d in Vn)Vn.hasOwnProperty(d)&&jo(Vn[d],a)});
